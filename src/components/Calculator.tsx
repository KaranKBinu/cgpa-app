...
export default function Calculator({ program }: { program: Program }) {
  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden font-sans">
      {/* Sidebar Navigation */}
      <aside className="w-16 lg:w-64 border-r-2 border-border/50 flex flex-col bg-card/30 z-[70]">
        <Tooltip content="PolyCGPA Home" position="right" variant="emerald" className="w-auto">
          <div className="p-4 lg:p-6 border-b-2 border-border/50 flex items-center justify-center lg:justify-start gap-3 bg-card/10">
      ...
      <main className="flex-1 overflow-y-auto bg-background custom-scrollbar animate-fade-in relative">
          ...
          <div className="flex items-center gap-2 lg:gap-3 w-full md:w-auto relative z-[60]">
            <Tooltip content="Internal Cloud Save" position="bottom" variant="emerald" className="w-full md:w-auto">
              <button
                ...
                className={cn(
                  "btn-primary w-full md:w-auto min-w-[120px] lg:min-w-[140px] h-10 lg:h-11",
        ...
        <div className="p-4 lg:p-12">
          ...
          <div className="grid grid-cols-1 gap-1">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            exclusions[sub.id] === 'not-published'
                              ...
                              : "border-border/50 text-muted-foreground hover:text-amber-400/80 hover:border-amber-400/30 hover:bg-amber-400/5"
                          )}
                        >
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            exclusions[sub.id] === 'not-taken'
                              ...
                              : "border-border/50 text-muted-foreground hover:text-red-500/80 hover:border-red-500/30 hover:bg-red-500/5"
                          )}
                        >
                          <X className="h-4 w-4" />
                        </button>
            ...
            {/* Footer Actions */}
            <div className="mt-8 lg:mt-12 flex flex-col lg:flex-row items-stretch lg:items-center justify-between p-6 lg:p-8 rounded-2xl bg-surface border border-border/50 gap-6 lg:gap-0">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 lg:gap-4 order-2 lg:order-1">
                <Tooltip content="Clear Semester">
                  <button
                    ...
                    className="btn-ghost w-full text-red-500 border border-transparent hover:border-red-500/20 hover:bg-red-500/5 group"
                  >
                ...
                <Tooltip content="Add Subject" variant="emerald">
                  <button
                    ...
                    className="btn-ghost w-full text-primary border border-transparent hover:border-emerald-500/20 hover:bg-emerald-500/5 group"
                  >
