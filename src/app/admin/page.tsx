  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-4xl font-black text-white tracking-tighter">System <span className="text-emerald-500">Overview</span></h1>
          <p className="text-white/40 font-medium">Real-time statistics and administrative metrics.</p>
        </div>
      ...
      <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 relative overflow-hidden">
        ...
        <h2 className="text-2xl font-black text-white mb-4">Welcome to the Command Center</h2>
...
function StatCard({ label, value, icon, color }: { label: string, value: number, icon: React.ReactNode, color: string }) {
  ...
  return (
    <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 flex flex-col justify-between h-48 group hover:border-white/20 transition-all">
