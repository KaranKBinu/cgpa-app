      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16 animate-fade-in">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm lg:text-lg font-medium tracking-tight">System-wide log of your academic computations and milestones.</p>
          </div>
          
          <div className="flex items-center gap-4 lg:gap-6 p-4 lg:p-6 rounded-[1.5rem] lg:rounded-[2rem] bg-card/50 border border-border/50 shadow-2xl w-full lg:w-auto">
             ...
             <div>
                <p className="text-[8px] lg:text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] mb-1">Stored Sessions</p>
                <p className="text-2xl lg:text-3xl font-black text-foreground leading-none">{calculations.length}</p>
             </div>
          </div>
        </div>
